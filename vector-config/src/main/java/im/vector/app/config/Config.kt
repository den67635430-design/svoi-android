...
object Config {
     ...
     */
    val DEBUG_ANALYTICS_CONFIG: Analytics = Analytics.Disabled

    /**
     * The analytics configuration to use for the Release build type.
     * Can be disabled by providing Analytics.Disabled
     */
    val RELEASE_ANALYTICS_CONFIG: Analytics = Analytics.Disabled

    /**
     * The analytics configuration to use for the Nightly build type.
     * Can be disabled by providing Analytics.Disabled
     */
    val NIGHTLY_ANALYTICS_CONFIG: Analytics = Analytics.Disabled
    val RELEASE_R_ANALYTICS_CONFIG: Analytics = Analytics.Disabled
    val ER_NIGHTLY_ANALYTICS_CONFIG: Analytics = Analytics.Disabled
    val ER_DEBUG_ANALYTICS_CONFIG: Analytics = Analytics.Disabled
